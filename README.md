...
```text
0.0.18 — Runtime Host Safety Hardening
```
...
- runtime process host safety hardening with manifest-bound executable validation and irreversible-stop cleanup semantics;
